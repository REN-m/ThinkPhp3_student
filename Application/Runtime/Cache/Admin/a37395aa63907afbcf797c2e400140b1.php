...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U('save');?>">添加品牌</a></span>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align="center"><img src="http://localhost/thinkphp3/Public/Admin/Images/<?php echo ($row["state"]); ?>.gif" alt=""></td>
                    <td align="center"><?php echo ($row["state"]); ?></td>
                    <td align="center"><?php echo date('Y-m-d H:i:s',$row['create_time']);?></td>
                    <td align="center">
                        <a href="<?php echo U('save',array('id'=>$row['id']));?>" title="编辑">编辑</a> |
                        <a href="<?php echo U('del',array('id'=>$row['id']));?>" title="删除">移除</a>
                    </td>
