...
<form method="post" action="" name="listForm">
    ...
    <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                        <td align="center"><?php echo ($row["id"]); ?></td>
                                    ...
                                    <td align="center"><?php echo ($row["textarea"]); ?></td>
            <td align="center"><img src="http://localhost/thinkphp3/Public/Admin/Images/<?php echo ($row["state"]); ?>.gif" alt=""></td>
                                    ...
                                    <td>
                <a href="<?php echo U('Dept/save',array('id'=>$row['id']));?>">编辑</a>
                |
                <a class="ajax-get" href="<?php echo U('Dept/del',array('id'=>$row['id']));?>">删除</a>
            </td>
