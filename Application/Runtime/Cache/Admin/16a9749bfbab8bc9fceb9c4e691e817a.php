...
<div class="main-div">
    -->
    <!--<form method="post" action="<?php echo U('Summary/save');?>" enctype="multipart/form-data">-->
        <!--<table cellspacing="1" cellpadding="3" width="100%">-->
            ...
            <!--<tr>-->
                ...
                <!--<td>-->
                    <!--<input type="text" name="fraction" maxlength="60" value="<?php echo ($fraction); ?>"/>-->
                    <!--<span class="require-field">*</span>-->
                <!--</td>-->
            <!--</tr>-->
            ...
            <!--<tr>-->
                ...
                <!--<td>-->
                    <!--<input type="text" name="avg" maxlength="60" value="<?php echo ($avg); ?>"/>-->
                    <!--<span class="require-field">*</span>-->
                <!--</td>-->
            <!--</tr>-->

            <!--<tr>-->
                <!--<td class="label">调查的人数</td>-->
                <!--<td>-->
