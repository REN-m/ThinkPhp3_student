...
<div class="main-div">
    ...
    <form method="post" action="<?php echo U('Menu/save');?>" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                <td class="label">导航id</td>
                <td>
                    <select name="nav_id" id="">
                        <option value="0">-选择-</option>
                        <?php if(is_array($navs)): $i = 0; $__LIST__ = $navs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?><option value="<?php echo ($nav["id"]); ?>"><?php echo ($nav["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <span class="require-field">*</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="path" maxlength="60" value="<?php echo ($row["path"]); ?>"/>
                    <span class="require-field">*</span>
                </td>
            </tr>
