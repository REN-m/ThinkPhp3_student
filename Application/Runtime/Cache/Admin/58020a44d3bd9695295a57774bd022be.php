...
<form method="post" action="" name="listForm">
    ...
    <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><?php echo ($row["fraction"]); ?></td>
            ...
            <td>
                <!--<a href="<?php echo U('Summary/save',array('id'=>$row['id']));?>">编辑</a>-->
                <!--|-->
                <!--<a class="ajax-get" href="<?php echo U('Summary/del',array('id'=>$row['id']));?>">删除</a>-->
            </td>
        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
    <a href="<?php echo U('Summary/idea',array('class_id'=>$row['class_id'],'teacher_id'=>$row['teacher_id']));?>"><h1>
        学生建议与问题</h1></a>
