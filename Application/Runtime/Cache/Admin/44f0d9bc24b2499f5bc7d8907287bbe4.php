...
<form method="post" action="" name="listForm">
    ...
    <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><a class="ajax-get" href="<?php echo U('State',array('id'=>$row['id'],'state'=>$row['state']));?>">
            ...
            <td>
                <a href="<?php echo U('Sorts/save',array('id'=>$row['id']));?>">编辑</a>
                |
                <a class="ajax-get" href="<?php echo U('Sorts/del',array('id'=>$row['id']));?>">删除</a>
            </td>
