...
<div class="main-div">
    ...
    <form method="post" action="<?php echo U('Dept/save');?>" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                <td class="label">描述textarea</td>
                <td>
                    <textarea name="textarea" cols="60" rows="4"><?php echo ($row["textarea"]); ?></textarea>
                    <span class="require-field">*</span>
                </td>
            </tr>
