...
defined('CONF_EXT')     or define('CONF_EXT',       'Goods.php'); // 配置文件后缀
...
if(!IS_CLI) {
    ...
    if(!defined('_PHP_FILE_')) {
        if(IS_CGI) {
            //CGI/FASTCGI模式下
            $_temp  = explode('Goods.php',$_SERVER['PHP_SELF']);
            define('_PHP_FILE_',    rtrim(str_replace($_SERVER['HTTP_HOST'],'',$_temp[0].'Goods.php'),'/'));
        }else {
