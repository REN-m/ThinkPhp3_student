 ...
 * @return void
 */
function load($name, $baseUrl='', $ext='Goods.php') {
 ...
 * @return boolean
 */
function vendor($class, $baseUrl = '', $ext='Goods.php') {
    if (empty($baseUrl))
        $baseUrl = VENDOR_PATH;
...
function load_ext_file($path) {
    ...
    if(C('LOAD_EXT_FILE')) {
        ...
        foreach ($files as $file){
            $file   = $path.'Common/'.$file.'Goods.php';
    ...
    if(C('LOAD_EXT_CONFIG')) {
        ...
        foreach ($configs as $key=>$config){
            $file   = $path.'Conf/'.$config.'Goods.php';
            if(is_file($file)) {
