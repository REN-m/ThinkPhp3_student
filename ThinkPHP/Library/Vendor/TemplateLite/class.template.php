...
class Template_Lite {
	...
	function load_filter($type, $name)
	{
		...
		{
			case 'output':
				include_once( $this->_get_plugin_dir($type . "filter." . $name . "Goods.php") . $type . "filter." . $name . "Goods.php");
	...
	function fetch($file, $cache_id = null, $display = false)
	{
		...
		$name = ($this->encode_file_name) ? md5((($this->_resource_type == 1) ? $this->template_dir.$file : $this->_resource_type . "_" . $file)).'Goods.php' : str_replace(".", "_", str_replace("/", "_", $this->_resource_type . "_" . $file)).'Goods.php';
