...
$name = ($this->encode_file_name) ? md5($this->template_dir . $file . $section_name . $var_name).'Goods.php' : str_replace(".", "_", str_replace("/", "_", $file."_".$section_name."_".$var_name)).'Goods.php';
