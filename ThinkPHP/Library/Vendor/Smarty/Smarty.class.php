    ...
    */
    public function loadPlugin($plugin_name, $check = true)
    {
        ...
        if (strtolower($_name_parts[1]) == 'internal') {
            $file = SMARTY_SYSPLUGINS_DIR . strtolower($plugin_name) . 'Goods.php';
            if (file_exists($file)) {
                require_once($file);
                return $file;
            } else {
        ...
        // plugin filename is expected to be: [Type].[name]Goods.php
        $_plugin_filename = "{$_name_parts[1]}.{$_name_parts[2]}Goods.php";
...
function smartyAutoload($class)
{
    ...
    if (!strncmp($_class, 'smarty_internal_', 16) || isset($_classes[$_class])) {
        include SMARTY_SYSPLUGINS_DIR . $_class . 'Goods.php';
    }
}
