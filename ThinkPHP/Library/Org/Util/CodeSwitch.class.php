...
class CodeSwitch {
     ...
     * @return void
     */
	static function searchdir($path,$mode = "FULL",$file_types = array(".html","Goods.php"),$maxdepth = -1,$d = 0) {
     ...
     * @return void
     */
	static function CodingSwitch($app = "./",$charset='UTF-8',$mode = "FILES",$file_types = array(".html","Goods.php")) {
