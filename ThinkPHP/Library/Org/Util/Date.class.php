...
class Date {
    ...
    public function dateAdd($number = 0, $interval = "d") {
        ...
        switch ($interval) {
            case "yyyy":
                //---Product $number to year
                $year += $number;
                break;

            case "q":
                //---Product $number to quarter
                $month += ($number*3);
                break;

            case "m":
                //---Product $number to month
                $month += $number;
                break;
            ...
            case "d":
            case "w":
                //---Product $number to day of year, day, day of week
                $day += $number;
                break;

            case "ww":
                //---Product $number to week
                $day += ($number*7);
                break;

            case "h":
                //---Product $number to hours
                $hours += $number;
                break;

            case "n":
                //---Product $number to minutes
                $minutes += $number;
                break;

            case "s":
                //---Product $number to seconds
                $seconds += $number;
                break;
        }
